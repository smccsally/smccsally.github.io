  ...
  $(document).ready(function() {
      ...
      $(document).ready(function() {
          ...
          for (var i = 1; i <= len; i++) {
              var sliderid = '#' + i + i;
              $('#5 #' + i).css({
                  'background': bgcolor[i - 1]
              });
              $(sliderid).css({
                  'opacity': '0',
                  'height': '0px'
              });
              $(sliderid + ' .comparison-slider-wrapper .comparison-slider > img').css({
                  'display': 'none'
              });
              // If the comparison slider is present on the page lets initialise it, this is good you will include this in the main js to prevent the code from running when not needed
              if ($(sliderid + " .comparison-slider")[0]) {
                  var compSlider = $(sliderid + " .comparison-slider");
                  //var's loop through the sliders and initialise each of them
      ...
      function drags(dragElement, resizeElement, container) {
          ...
          dragElement.on("mousedown touchstart", function(e) {
              ...
              dragElement.parents().on("mousemove touchmove", function(e) {
                  // if the user is not using touch input var do preventDefault to prevent the user from slecting the images as he moves the silder arround.
                  if (touched === false) {
                      e.preventDefault();
                  }
      ...
      $('.close').on('click', function() {
          ...
          $('.overlayTop .comparison-slider-wrapper .comparison-slider > img').css({
              'display': 'none'
          });
